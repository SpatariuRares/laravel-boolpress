...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPostDetail: function getPostDetail() {
      ...
      axios.post("/api" + this.$route.path, bodyParameter, config).then(function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPosts: function getPosts() {
      ...
      axios.post("/api/posts", bodyParameter, config).then(function (response) {
...
var render = function () {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("h1", [_vm._v("Dettaglio del post")]),
...
module.exports = __webpack_require__(/*! C:\Users\spata\Documents\roba\corso boolean\esercizi\lavarel\laravel-boolpress\resources\js\front.js */"./resources/js/front.js");
